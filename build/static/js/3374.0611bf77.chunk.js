...
`;const W=20;function X(e){const n=(0,h.Tz)(e),t=(0,h.uw)((0,z.Dv)(l.X3)),{data:i}=(0,h.eE)((0,Q.FL)({variables:{duration:t,chain:e}}),h.u8.Slow),r=(0,g.useMemo)((()=>{const e=n&&i?.topTokens?.map((e=>(0,h.vR)(n,e))),t={};return e?.forEach((e=>e?.address&&(t[e.address]=e?.market?.priceHistory?.filter(h.yL)))),t}),[n,i?.topTokens]),{data:o,loading:a}=(0,h.eE)((0,Q.le)({variables:{duration:t,chain:e}}),h.u8.Fast),s=function(e){const n=(0,z.Dv)(l.AY),t=(0,z.Dv)(l.$E);return(0,g.useMemo)((()=>{if(!e)return;let i=Array.from(e);switch(n){case l.PU.PRICE:i=i.sort(((e,n)=>(n?.market?.price?.value??0)-(e?.market?.price?.value??0)));break;case l.PU.PERCENT_CHANGE:i=i.sort(((e,n)=>(n?.market?.pricePercentChange?.value??0)-(e?.market?.pricePercentChange?.value??0)));break;case l.PU.TOTAL_VALUE_LOCKED:i=i.sort(((e,n)=>(n?.market?.totalValueLocked?.value??0)-(e?.market?.totalValueLocked?.value??0)));break;case l.PU.VOLUME:i=i.sort(((e,n)=>(n?.market?.volume?.value??0)-(e?.market?.volume?.value??0)))}return t?i.reverse():i}),[e,n,t])}((0,g.useMemo)((()=>n&&o?.topTokens?.map((e=>(0,h.vR)(n,e)))),[n,o])),c=(0,g.useMemo)((()=>s?.reduce(((e,n,t)=>n.address?{...e,[n.address]:t+1}:e),{})??{}),[s]),d=function(e){const n=(0,z.Dv)(l.fO),t=(0,g.useMemo)((()=>n.toLowerCase()),[n]);return(0,g.useMemo)((()=>{if(!e)return;let n=e;return t&&(n=n?.filter((e=>{const n=e?.address?.toLowerCase().includes(t),i=e?.name?.toLowerCase().includes(t),r=e?.symbol?.toLowerCase().includes(t);return i||r||n}))),n}),[e,t])}(s);return(0,g.useMemo)((()=>({tokens:d,tokenSortRank:c,loadingTokens:a,sparklines:r})),[d,c,a,r])}var K=t(34578),G=t(97220),Y=t(57284);const ee=E.default.div.withConfig({displayName:"TokenTable__GridContainer",componentId:"sc-e49e71a7-0"})`
  ...
  align-items: center;
  border: 1px solid ${({theme:e})=>e.surface3};
`,ne=E.default.div.withConfig({displayName:"TokenTable__TokenDataContainer",componentId:"sc-e49e71a7-1"})`
  display: flex;
  flex-direction: column;
  gap: 4px;
  height: 100%;
  width: 100%;
`,te=E.default.div.withConfig({displayName:"TokenTable__NoTokenDisplay",componentId:"sc-e49e71a7-2"})`
  display: flex;
  justify-content: center;
  width: 100%;
  height: 60px;
  ...
  padding: 0px 28px;
  gap: 8px;
`;function ie({message:e}){return(0,i.jsxs)(ee,{children:[(0,i.jsx)(Y.VJ,{}),(0,i.jsx)(te,{children:e})]})}const re=({rowCount:e})=>(0,i.jsx)(i.Fragment,{children:Array(e).fill(null).map(((n,t)=>(0,i.jsx)(Y.PI,{first:0===t,last:t===e-1},t)))});function oe({rowCount:e=W}){return(0,i.jsxs)(ee,{children:[(0,i.jsx)(Y.VJ,{}),(0,i.jsx)(ne,{children:(0,i.jsx)(re,{rowCount:e})})]})}function ae(){const e=(0,h.Qj)((0,_.UO)().chainName),[n]=(0,g.useState)(!1),{tokens:t,tokenSortRank:o,loadingTokens:a,sparklines:s}=X(e),c=G.u;return a&&!c?(0,i.jsx)(oe,{rowCount:W}):c?0===c?.length?(0,i.jsx)(ie,{message:(0,i.jsx)(r.cC,{id:"k4nIkP"})}):(0,i.jsxs)(ee,{children:[(0,i.jsx)(Y.VJ,{}),(0,i.jsx)(ne,{children:c.map(((e,n)=>e?.address&&(0,i.jsx)(Y.pS,{tokenListIndex:n,tokenListLength:c.length,token:e,sparklineMap:s},e.address)))})]}):(0,i.jsx)(ie,{message:(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(K.Z,{size:16}),(0,i.jsx)(r.cC,{id:"lR4CZT"})]})})}var se=t(65647);const ce=E.default.div.withConfig({displayName:"Explore__ExploreContainer",componentId:"sc-72ff4a27-0"})`
  width: 100%;
  min-width: 320px;
...
`,le=E.default.div.withConfig({displayName:"Explore__TitleContainer",componentId:"sc-72ff4a27-1"})`
  margin-bottom: 32px;
  max-width: ${c.y5};
  margin-left: auto;
  margin-right: auto;
  display: flex;
`,de=E.default.div.withConfig({displayName:"Explore__NavWrapper",componentId:"sc-72ff4a27-2"})`
  display: flex;
  max-width: ${c.y5};
  margin: 0 auto;
  ...
  ${({isInfoExplorePageEnabled:e})=>e&&E.css`
    ...
    `};
`,ue=(0,E.default)(s.BA).withConfig({displayName:"Explore__TabBar",componentId:"sc-72ff4a27-3"})`
  gap: 24px;
  @media screen and (max-width: ${({theme:e})=>e.breakpoint.md}px) {
    gap: 16px;
  }
`,fe=(0,E.default)(j.Tv.HeadlineMedium).withConfig({displayName:"Explore__TabItem",componentId:"sc-72ff4a27-4"})`
  align-items: center;
...
`,pe=E.default.div.withConfig({displayName:"Explore__FiltersContainer",componentId:"sc-72ff4a27-5"})`
  display: flex;
  gap: 8px;
  height: 40px;
...
`,he=(0,E.default)(pe).withConfig({displayName:"Explore__DropdownFilterContainer",componentId:"sc-72ff4a27-6"})`
  ${({isInfoExplorePageEnabled:e})=>e?E.css`
          @media screen and (max-width: ${({theme:e})=>e.breakpoint.md}px) {
        ...
        `};
`,xe=(0,E.default)(pe).withConfig({displayName:"Explore__SearchContainer",componentId:"sc-72ff4a27-7"})`
