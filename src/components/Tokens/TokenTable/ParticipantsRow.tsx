...
import { filterStringAtom, filterTimeAtom, ParticipantsSortMethod } from '../state'
...
export const HEADER_DESCRIPTIONS: Record<ParticipantsSortMethod, ReactNode | undefined> = {
  [ParticipantsSortMethod.PRICE]: undefined,
...
function HeaderCell({
  ...
  category: ParticipantsSortMethod // TODO: change this to make it work for trans
}) {
...
export function HeaderRow() {
  return (
    <TokenRow
      header={true}
      listNumber="#"
      tokenInfo={<Trans>Participant name</Trans>}
      price={<HeaderCell category={ParticipantsSortMethod.PRICE} />}
      percentChange={<HeaderCell category={ParticipantsSortMethod.PERCENT_CHANGE} />}
      tvl={<HeaderCell category={ParticipantsSortMethod.TOTAL_VALUE_LOCKED} />}
      volume={<HeaderCell category={ParticipantsSortMethod.VOLUME} />}
      sparkLine={null}
    />
  )
}
